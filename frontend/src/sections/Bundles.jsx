                ...
                <div className="relative rounded-2xl overflow-hidden mb-16 h-64 shadow-xl">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-primary/80 to-transparent flex items-center px-6 md:px-12">
                        <div className="text-white max-w-md">
                            ...
                            <h4 className="text-2xl md:text-3xl font-bold mb-2">Life in Spain,<br/>Exactly as You Imagined</h4>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start max-w-4xl mx-auto">
                    {bundles.map((bundle, index) => (
                        <motion.div
                            ...
                            className={`relative rounded-2xl p-6 md:p-8 shadow-xl ${bundle.dark ? 'bg-primary text-white border-primary border' : 'bg-white border-gray-100 border'}`}
                        >
                            <div className="text-sm font-bold uppercase tracking-wider mb-2 text-accent">
                                {bundle.label}
                            </div>
                            <h4 className={`text-2xl md:text-3xl font-bold mb-4 ${bundle.dark ? 'text-white' : 'text-primary'}`}>
                                {bundle.name}
                            </h4>
